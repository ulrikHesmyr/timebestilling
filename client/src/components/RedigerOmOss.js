...
function RedigerOmOss({env, varlseFeil, varsle, lagreVarsel, sUpdateTrigger, updateTrigger}){
    ...
    async function leggTilInnhold(objektet){
        ...
        try {
          ...
          const response = await fetch("http://localhost:1228/env/leggTilInnhold", options);
    ...
    async function leggTilBilde(){
        ...
        try {
            ...
            const response = await fetch("http://localhost:1228/env/lastOppBilde/" + mittObjekt.content, options);
            const data = await response.json();
            if(data){
                varsle();
                sUpdateTrigger(!updateTrigger);
    ...
    async function slettInnhold(content){
        ...
        try {
            ...
            const response = await fetch("http://localhost:1228/env/slettInnhold", options);
            const data = await response.json();
            if(data){
                varsle();
                sUpdateTrigger(!updateTrigger);
    ...
    async function flyttOpp(index){
        if(index !== 0){
            ...
            try {
                ...
                const request = await fetch("http://localhost:1228/env/flyttOpp", options);
    ...
    async function flyttNed(index){
        if(index !== omOssFeed.length-1){
            ...
            try {
                ...
                const request = await fetch("http://localhost:1228/env/flyttNed", options);
                const data = await request.json();
                if(data){
                    varsle();
                    sUpdateTrigger(!updateTrigger);
