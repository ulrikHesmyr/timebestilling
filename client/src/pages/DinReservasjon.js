...
export default function DinReservasjon({setReservasjon ,registrertReservasjon}){
    ...
    return (
        <div className='reservasjon'>
            ...
            {(registrertReservasjon?(<div> 
                <p>Din time er {registrertReservasjon.dato} klokken {registrertReservasjon.tidspunkt}</p>
